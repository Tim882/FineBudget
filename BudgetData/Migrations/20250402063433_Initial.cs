        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiabilityId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Costs_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Costs_Liabilities_LiabilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Incomes_Assets_AssetId",
                        column: x => x.AssetId,
                        principalTable: "Assets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Incomes_Liabilities_LiabilityId",
                        column: x => x.LiabilityId,
                        principalTable: "Liabilities",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Costs_AssetId",
                table: "Costs",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Costs_LiabilityId",
                table: "Costs",
                column: "LiabilityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Incomes_AssetId",
                table: "Incomes",
                column: "AssetId");

            migrationBuilder.CreateIndex(
                name: "IX_Incomes_LiabilityId",
                table: "Incomes",
                column: "LiabilityId");
        }
